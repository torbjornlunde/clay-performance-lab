...
export default function EquipmentPage() {
  ...
  return <main>
    <Datalist id="shotgun-manufacturers" options={SHOTGUN_MANUFACTURERS} /><Datalist id="shotgun-models" options={modelOptions} /><Datalist id="choke-manufacturers" options={CHOKE_MANUFACTURERS} /><Datalist id="ammunition-manufacturers" options={AMMUNITION_MANUFACTURERS} />
