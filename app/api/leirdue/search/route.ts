...
import { FETCH_ERROR_MESSAGE } from "@/lib/leirdue/parser";
import { normalizeLeirdueShooterName, queryOrBuildLeirdueYearIndex } from "@/lib/leirdue/index";
...
export async function POST(request: Request) {
  ...
  try {
    const result = await queryOrBuildLeirdueYearIndex({ shooterName, year, disciplines, continuationToken });
