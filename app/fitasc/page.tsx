    ...
    <main>
      ...
      {isFullscreen && (
        <div className="fitascFullscreenOverlay" role="dialog" aria-modal="true" aria-labelledby="fitasc-fullscreen-title">
          <div className={viewMode === "stand" ? "fitascFullscreenPanel fitascFullscreenPanelStand fitascFullscreenPanelV2" : "fitascFullscreenPanel"}>
            <div className="fitascFullscreenHeader">
              <div>
                ...
                {viewMode === "stand" && <span className="fitascProofMarker">FITASC fullscreen v2</span>}
