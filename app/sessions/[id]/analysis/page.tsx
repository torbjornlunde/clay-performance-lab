  ...
  return (
    <main>
      ...
      <div className="card">
        ...
        <p>
          <strong>Machine/target label:</strong> {analysis.formatted.byTargetLabel}
        </p>
        <p>
          ...
          misses.map((miss) => (
            <div className="subcard" key={miss.id}>
              ...
              <div className="small muted">
                {miss.target_label || "-"} · {miss.target_type || "-"} · {miss.missed_target} · {miss.where_miss || "-"} · {miss.main_reason || "-"}
              </div>
