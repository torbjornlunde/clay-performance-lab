...
export default function TrainingScoreSheetPage() {
  ...
  const autosaveKey = localDraftKey(sheetId);

  function buildLocalDraft(synced: boolean): LocalScoreSheetDraft {
    return {
      version: 1,
      sheetId,
  ...
  function writeLocalDraft(synced: boolean) {
    if (typeof window === "undefined") return;
    try {
      window.localStorage.setItem(autosaveKey, JSON.stringify(buildLocalDraft(synced)));
