...
export type LeirdueSearchDebug = {
  ...
  autoContinuedBecausePendingQueue: boolean;
  autoStopReason: "safetyTimeLimitReached" | "maxAutoBatchesReached" | "selectedYearWorkExhausted" | "onlyOldFallbackRemains" | "realError" | "targetReached" | null;
  selectedYearWorkRemaining: boolean;
  ...
  candidateDebugRows: { url: string; name: string; date: string | null; discipline: string; shootingGround: string | null; shootingGroundSource: string; ownScore: number | null; totalTargets: number | null; winningScore: number | null; category: LeirdueCategory; confidence: LeirdueConfidence; importRecommended: boolean; reason: string; hiddenFromNormalUi: boolean; totalTargetsSource: string | null; inferredTotalTargets: number | null; inferenceConfidence: string | null; hiddenReason: string | null; listTypeDetected: string | null; nmRowContextBefore: string | null; nmRowContextAfter: string | null; notes: string }[];
