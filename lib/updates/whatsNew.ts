...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
  { id: "v29.09.26", title: "Clearer progress for Leirdue.net year searches", bullets: ["An unfinished year now stays marked as incomplete while the shared result index catches up.", "The daily background update processes more of the remaining results, so older competitions become available sooner without restarting your search."], href: "/import/leirdue", linkLabel: "Search Leirdue.net results" },
  ...
  { id: "v8.09.26", title: "Import public ClayArena results", bullets: ["Paste a public ClayArena competition results link and find your shooter row.", "Review and correct the score, target total, discipline and venue before saving.", "Keep shoot-off scores separate from the base competition score and avoid importing the same result twice."], href: "/import/clayarena", linkLabel: "Import a ClayArena result" },
