...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
  { id: "v10.09.26", title: "Save competitions with fewer choices", bullets: ["Start with one recommended Add competition action and add detail only when it is useful.", "Import a published ClayArena or Leirdue.net result from one clearly marked path.", "Find live score sheets, quick scoring and detailed setup under Other ways to start."] },
