...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
  { id: "v10.09.26", title: "Find the ClayArena importer more easily", bullets: ["Open ClayArena import directly from Log competition or Results history.", "Use the clear ClayArena button on the Leirdue.net import page to switch result sources."], href: "/import/clayarena", linkLabel: "Import from ClayArena" },
