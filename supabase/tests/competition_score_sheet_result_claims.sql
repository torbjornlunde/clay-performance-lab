...
do $$ declare rev timestamptz; sheet record; begin
 ...
 for sheet in select id,updated_at from public.training_score_sheets where id in ('10000000-0000-0000-0000-000000000280','10000000-0000-0000-0000-000000000281','10000000-0000-0000-0000-000000000282') order by id loop
...
do $$ begin
 ...
 if (select count(*) from public.get_my_competition_score_sheet_results())<>4 then raise exception 'claim projection leaked or omitted rows'; end if;
...
do $$ declare sporttrap_id uuid; kompakt_id uuid; leirduesti_id uuid; begin
...
do $$ declare first_id uuid; retry_id uuid; begin
 ...
 if (select count(*) from public.misses where session_id=first_id and source_type='competition_score_sheet_claim' and course_number=1 and target_position=2)<>1 then raise exception 'known Compak miss mapping wrong'; end if;
