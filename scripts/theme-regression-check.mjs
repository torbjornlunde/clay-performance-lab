...
const componentExpectations = [
  ...
  ['.resultsSummaryTable', [['background', '--surface-inset'], ['color', '--text-primary']]],
  ...
  ['.leirdueHealthPage .dangerCallout', [['background', '--danger-bg'], ['color', '--danger-text'], ['border-color', '--danger-border']]],
