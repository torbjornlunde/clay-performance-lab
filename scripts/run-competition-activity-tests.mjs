...
const rows = [
  ...
  { id: 'leirdue-import-canonical', session_type: 'Competition', total_targets: 25, competition_date: '2026-04-01', created_at: '2026-04-02T00:00:00Z', leirdue_result_url: 'https://www.leirdue.net/Resultater/Resultat?Stevne=1&Liste=2' },
  { id: 'leirdue-import-duplicate', session_type: 'Competition', total_targets: 25, competition_date: '2026-04-01', created_at: '2026-04-02T01:00:00Z', leirdue_result_url: 'https://www.leirdue.net/Resultater/Resultat?Liste=2&Stevne=1#top' },
...
assert.equal(summary2026.allTimeCompetitionCount, 6, 'detailed/result-only/imported canonical competition sessions are counted once each and exact Leirdue URL duplicates are skipped');
assert.equal(summary2026.allTimeCompetitionTargetCount, 280, 'known all-time competition targets are summed without inventing unknown targets or double-counting duplicate Leirdue URLs');
assert.equal(summary2026.selectedYearCompetitionCount, 3, 'current-year filtering includes only canonical competitions in selected year');
...
const withSupportingRecords = buildCompetitionActivitySummary([
  { id: 'canonical-session', session_type: 'Competition', total_targets: 25, competition_date: '2026-01-01', created_at: '2026-01-01T00:00:00Z', notes: 'source: leirdue_net. source_url: https://www.leirdue.net/resultater/resultat?liste=7&stevne=9' },
  { id: 'canonical-session-duplicate', session_type: 'Competition', total_targets: 25, competition_date: '2026-01-01', created_at: '2026-01-01T01:00:00Z', leirdue_result_url: 'https://www.leirdue.net/resultater/resultat?stevne=9&liste=7' },
