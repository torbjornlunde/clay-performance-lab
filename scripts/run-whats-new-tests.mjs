...
assert.deepEqual(groups[0].entries.map(({ id }) => id), ["v12.08.26", "v11.08.26", "v10.08.26", "v9.08.26", "v8.08.26", "v7.08.26", "v6.08.26", "v5.08.26", "v4.08.26", "v3.08.26", "v2.08.26", "v1.08.26"], "newest update is first within month");
assert.equal(updates.latestWhatsNewEntry(entries).id, "v12.08.26", "latest update is deterministic");
