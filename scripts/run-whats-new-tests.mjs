...
assert.deepEqual(groups[0].entries.map(({ id }) => id), ["v17.09.26", "v16.09.26", "v15.09.26", "v14.09.26", "v13.09.26", "v12.09.26", "v11.09.26", "v10.09.26", "v9.09.26", "v8.09.26", "v7.09.26", "v6.09.26", "v5.09.26", "v4.09.26", "v3.09.26", "v2.09.26", "v1.09.26"], "September sequence is newest first without gaps");
...
assert.equal(updates.latestWhatsNewEntry(entries).id, "v17.09.26", "latest update is deterministic");
