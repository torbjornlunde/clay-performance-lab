...
const normalizedContext = buildLeirdueFieldContext({ ...session, own_score: 45, total_targets: 50 }, [
  { event_id: 'n1', liste_id: 'l', normalized_name: 'repeat', original_name: 'Repeat', placement: 2, score: 45, total_targets: 50, discipline: 'Leirduesti', event_date: '2026-07-01', event_title: 'NM Leirduesti', source_url: 'n1' },
  { event_id: 'n2', liste_id: 'l', normalized_name: 'repeat', original_name: 'Repeat', placement: 2, score: 180, total_targets: 200, discipline: 'Leirduesti', event_date: '2026-07-02', event_title: 'NM Leirduesti', source_url: 'n2' },
]);
...
const urlRows = [{ event_id: '42', liste_id: '7', normalized_name: 'a', original_name: 'A', placement: 1, score: 25, total_targets: 25, discipline: 'Leirduesti', event_date: '2026-07-01', event_title: 'URL Cup', organizer: 'Oslo', source_url: 'https://leirdue.net/results?liste_id=7&stevne=42' }];
